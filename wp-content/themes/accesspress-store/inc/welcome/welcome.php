	...
	class Accesspress_Store_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Required Plugins', 'accesspress-store'),
						...
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-demos">
								...
								<div>
									...
									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'accesspress-store' ); ?></p>
							...
							<div class="apwelcome-column col-doc">
								...
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'accesspress-store' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										...
										<div class= "notice-sidebar-item">
											...
											<a href="https://wordpress.org/support/theme/accesspress-store/reviews/#new-post"><?php echo esc_html('Write a review','accesspress-store') ?></a>
